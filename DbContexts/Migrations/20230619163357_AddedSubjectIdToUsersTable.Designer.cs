...
namespace Centers.API.DbContexts.Migrations
{
    ...
    [Migration("20230619163357_AddedSubjectIdToUsersTable")]
    partial class AddedSubjectIdToUsersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Centers.API.Entities.ExamQuestionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Centers.API.Entities.CenterEntity", b =>
                {
                    b.HasOne("Centers.API.Entities.UserEntity", "Owner")
                        .WithOne("Center")
                        .HasForeignKey("Centers.API.Entities.CenterEntity", "OwnerId")
            ...
            modelBuilder.Entity("Centers.API.Entities.UserEntity", b =>
                {
                    ...
                    b.HasOne("Centers.API.Entities.SubjectEntity", "Subject")
                        .WithOne("Teacher")
                        .HasForeignKey("Centers.API.Entities.UserEntity", "SubjectId");
